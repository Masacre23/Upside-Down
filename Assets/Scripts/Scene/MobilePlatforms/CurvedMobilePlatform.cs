...
public class CurvedMobilePlatform : MonoBehaviour
{
    ...
    public Vector3 m_rotation_direction = new Vector3(0.0f, 0.0f, 1.0f);
    public float m_rotation_speed = 0.2f;
    ...
    void Update()
    {
        if (!m_waiting)
        {
            ...
            transform.Rotate(m_sense * m_rotation_direction * m_rotation_speed * Time.deltaTime);
